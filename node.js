...
;
	...
	($mol_mem(($.$apxu_samosbor_map_block.prototype), "postal_icon"));
	($mol_mem(($.$apxu_samosbor_map_block.prototype), "laundry_icon"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $apxu_samosbor_map_block.prototype, "has_postal_place", null);
        __decorate([
            $mol_mem
        ], $apxu_samosbor_map_block.prototype, "has_laundry_place", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $apxu_samosbor_map_block.prototype, "postal_place", null);
        __decorate([
            $mol_mem
        ], $apxu_samosbor_map_block.prototype, "laundry_place", null);
        __decorate([
            $mol_mem
...
;
	...
	($.$apxu_samosbor_map_block_card) = class $apxu_samosbor_map_block_card extends ($.$mol_view) {
		...
		laundrys(){
			const obj = new this.$.$apxu_samosbor_map_block_card_place();
			(obj.floors) = () => ((this.place_floors("laundry")));
			(obj.icon) = () => ((this.laundry_icon()));
			(obj.enabled) = () => ((this.edit_mode()));
			(obj.add_floor) = (next) => ((this.add_place("laundry", next)));
			(obj.remove_floor) = (id) => ((this.remove_place(id)));
			return obj;
		}
		postal_icon(){
		...
		postals(){
			const obj = new this.$.$apxu_samosbor_map_block_card_place();
			(obj.floors) = () => ((this.place_floors("postal")));
			(obj.icon) = () => ((this.postal_icon()));
			(obj.enabled) = () => ((this.edit_mode()));
			(obj.add_floor) = (next) => ((this.add_place("postal", next)));
			(obj.remove_floor) = (id) => ((this.remove_place(id)));
			return obj;
		}
		places(){
	...
	($mol_mem(($.$apxu_samosbor_map_block_card.prototype), "laundry_icon"));
	($mol_mem(($.$apxu_samosbor_map_block_card.prototype), "laundrys"));
	($mol_mem(($.$apxu_samosbor_map_block_card.prototype), "postal_icon"));
	($mol_mem(($.$apxu_samosbor_map_block_card.prototype), "postals"));
...
;
	($.$apxu_samosbor_map_app) = class $apxu_samosbor_map_app extends ($.$mol_view) {
		...
		lord_string(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.lord_ref(id)));
			(obj.value) = (next) => ((this.lord_name(id, next)));
			return obj;
		}
		lord_key(id){
			return "";
		...
		Gift_rank(id){
			...
			(obj.value) = (next) => ((this.gift_rank(id, next)));
			(obj.dictionary) = () => ({
				"deny": (this.$.$mol_locale.text("$apxu_samosbor_map_app_Gift_rank_dictionary_deny")), 
				"read": (this.$.$mol_locale.text("$apxu_samosbor_map_app_Gift_rank_dictionary_read")), 
				"join": (this.$.$mol_locale.text("$apxu_samosbor_map_app_Gift_rank_dictionary_join")), 
				"post": (this.$.$mol_locale.text("$apxu_samosbor_map_app_Gift_rank_dictionary_post")), 
				"rule": (this.$.$mol_locale.text("$apxu_samosbor_map_app_Gift_rank_dictionary_rule"))
			});
			return obj;
		}
		Lord(id){
		...
		CartographerRole(){
			...
			(obj.label) = () => (["Картографы"]);
			(obj.content) = () => ([(this.key_input()), ...(this.lords())]);
			return obj;
		}
		RolesController(){
			const obj = new this.$.$mol_expander();
			(obj.label) = () => (["Роли"]);
			(obj.content) = () => ([(this.Right()), (this.CartographerRole())]);
			return obj;
		}
		public_key(){
			return "pub key";
	...
	($mol_mem_key(($.$apxu_samosbor_map_app.prototype), "lord_string"));
	($mol_mem_key(($.$apxu_samosbor_map_app.prototype), "copy_key"));
	($mol_mem_key(($.$apxu_samosbor_map_app.prototype), "gift_rank"));
	($mol_mem_key(($.$apxu_samosbor_map_app.prototype), "Gift_rank"));
	($mol_mem_key(($.$apxu_samosbor_map_app.prototype), "Lord"));
	($mol_mem(($.$apxu_samosbor_map_app.prototype), "CartographerRole"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.RoleInfo = RoleInfo;
        class Roles extends $hyoo_crus_home.with({
            ...
            keys_ranks() {
                ...
                return roles.map((role) => {
                    ...
                    return { key: role.Key(null)?.val(), rank: (rank ? Number(rank) : $hyoo_crus_rank_post("just")) };
                });
            }
            public_keys() {
                const roles = this.get_roles();
        ...
        __decorate([
            $mol_mem
        ], Roles.prototype, "get_roles", null);
        __decorate([
            $mol_action
        ], Roles.prototype, "add_key", null);
        __decorate([
            $mol_mem
        ], Roles.prototype, "keys_ranks", null);
        __decorate([
            $mol_mem
        ], Roles.prototype, "public_keys", null);
        __decorate([
            $mol_mem
        ], Roles, "global", null);
        $$.Roles = Roles;
        class Gigacluster extends ($hyoo_crus_home.with({
            ...
            give_rights(land, public_key, rank = $hyoo_crus_rank_post("just")) {
        ...
        __decorate([
            $mol_action
        ], Gigacluster.prototype, "give_rights", null);
        __decorate([
            $mol_mem
        ], Gigacluster.prototype, "blocks", null);
        __decorate([
            $mol_mem
        ], Gigacluster, "is_admin", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $apxu_samosbor_map_app.prototype, "lords", null);
        __decorate([
            $mol_mem_key
        ], $apxu_samosbor_map_app.prototype, "lord_ref", null);
        __decorate([
            $mol_mem_key
        ], $apxu_samosbor_map_app.prototype, "lord_name", null);
        __decorate([
            $mol_mem_key
        ], $apxu_samosbor_map_app.prototype, "lord_key", null);
        __decorate([
            $mol_mem_key
        ], $apxu_samosbor_map_app.prototype, "gift_rank", null);
        __decorate([
            $mol_mem
